...
from sqlalchemy import (
    Column, String, Text, Integer, Boolean, DateTime, ForeignKey, JSON, Enum, Index
)
...
class Node(Base):
    ...
    return_node = Column(String(50), nullable=True)
...
class Edge(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    from_node_id = Column(String(50), ForeignKey("nodes.id", ondelete="CASCADE"), nullable=False, index=True)
